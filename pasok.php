...
if(isset($_POST['simpan'])){
  if($id_buku =="" || $id_dis==""){
    echo "<script>alert('Kolom distributor dan buku tidak boleh kosong!');document.location.href='$req'</script>";
  }else{
        ...
        <div>
            <div class="form-group">
              <label class="form-label">ID PASOK</label>
                <div class="">
                  <input type="text" id="" class="form-control" name="id_pasok" value="<?php echo $id_pas ?>"readonly required>
                </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-auto">
                  <input readonly type="text" name="id_buku" class="form-control" value="<?php echo @$tampil['id_buku'] ?>" required></div>
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-auto">
                  ...
                  <div class="col-auto"><button type="button" name="btn_dis" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#disModal">CARI Distributor</button></div>
              </div>
            </div>
            <div class="form-group">
              <label class="form-label">Jumlah</label>
              <div class="">
                <input type="number" min="0" name="jumlah" class="form-control" value="<?php ?>" required>
              </div>
            </div>
