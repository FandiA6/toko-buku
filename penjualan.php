...
if(isset($_POST['simpanbuku'])){
  if($id_buku =='' || $jumlah==''){
    echo "<script>alert('Silahkan Pilih buku terlebih dahulu/jumlah beli tidak boleh kosong');document.location.href='$req'</script>";
  }
  else{
...
if(isset($_POST['updatebuku'])){
  if($id_buku =='' || $jumlah=='' ){
    echo "<script>alert('Silahkan Pilih buku terlebih dahulu/jumlah beli tidak boleh kosong');document.location.href='?menu=penjualan&pilih&id=$id_buku'</script>";
  }
  else{
    @$fieldubah = array('jumlah_beli'=>$jumlah,'total_harga'=>$total);
    $go->ubah($con,$tabelsementara,$fieldubah,$where,$req);
  }
 
  // $q="UPDATE tmp_penjualan SET jumlah_beli = '$jumlah', total_harga = '$total' WHERE id_buku = '$id_buku' )";
...
if(isset($_POST['simpantransaksi'])){
  $bayar = $_POST['bayar'];
  if($bayar==''){
    echo "<script>alert('Silahkan Masukan Nominal Bayar');document.location.href='$req'</script>";
  }else{
  ...
  <div class="container w-75 mt-3 pt-3">
      <form method="post" class="">
          <div>
              ...
              if($cek==1){?>
                <button class="mt-3 btn btn-dark p-2" name="updatebuku">Update</button>
              <?php }else { ?>        
          ...
          <div class="container w-75 mt-3 pt-3 mb-5">
